<div x-data="uploadThumbnail()" class="mb-4">
    <label class="block mb-1 font-semibold">Thumbnail (Gambar)</label>
    <div
    ...
    >
        ...
        <input type="file" name="thumbnail" x-ref="input" class="hidden" accept="image/*" @change="handleFile($event)">
    </div>
    <template x-if="error">
